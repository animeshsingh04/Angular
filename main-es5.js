...
var ApiLogComponent = /** @class */ (function () {
    function ApiLogComponent(apiLogServie) {
    ...
    ApiLogComponent.prototype.selected = function (event) {
    ...
    Object.defineProperty(ApiLogComponent.prototype, "listFilter", {
        get: function () {
    ...
    ApiLogComponent.prototype.filterData = function (filterby) {
        var _this = this;
        if (this._selectedValue === "" || this._selectedValue === undefined) {
            ...
            return this.filteredapilogs = this.apilogs.filter(function (item) {
                return item[_this._selectedValue].toLowerCase().includes((filterby).toLowerCase());
            });
        }
    };
    ApiLogComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.apiLogServie.getApiLogs().subscribe({
            next: function (apilogs) {
                _this.logs = apilogs;
                _this.apilogs = _this.apiLogServie.getJsonObject(apilogs).
                    sort(function (a, b) {
                    var dateA = new Date(a.date).getTime();
                    var dateB = new Date(b.date).getTime();
                    return dateA > dateB ? 1 : -1;
                });
                _this.filteredapilogs = _this.apilogs;
                _this.distinctapi = _this.apiLogServie.distinctapipoint;
                console.log(_this.distinctapi);
            },
            error: function (err) {
    ...
    ApiLogComponent.ctorParameters = function () { return [
...
var ApiLogService = /** @class */ (function () {
    function ApiLogService(http) {
        this.http = http;
        this.LogUrl = 'api/logs/theon-api.txt';
        this.apilogsjson = [];
        this.distinctapipoint = [];
    }
    ApiLogService.prototype.getApiLogs = function () {
    ...
    ApiLogService.prototype.handleError = function (err) {
        var errorMessage = '';
    ...
    ApiLogService.prototype.getJsonObject = function (data) {
        var currentStr = data.split('\n');
        var apiLastindex;
        for (var i = 0; i < currentStr.length - 1; i++) {
            ...
            this.distinctapipoint = this.distinctapipoint.filter(function (x, i, a) { return x && a.indexOf(x) === i; });
        }
        return this.apilogsjson;
    };
    ApiLogService.ctorParameters = function () { return [
...
var WelcomeComponent = /** @class */ (function () {
    function WelcomeComponent() {
        this.pageTitle = 'Welcome Api Log';
    }
